...
export function up(next: () => void): void {
  db.exec(`
    CREATE TABLE nodes (
      ...
      coordinatorStatus TEXT CHECK( coordinatorStatus IN ('stopped','running') ) NOT NULL DEFAULT 'stopped',
      ...
      validatorStatus TEXT CHECK( validatorStatus IN ('stopped','running') ) NOT NULL DEFAULT 'stopped',
